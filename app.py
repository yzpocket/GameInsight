...
#    msg = request.args.get("msg")
#    return render_template_modal('loginForm.html', msg=msg)
...
#       # 'user_password1' : user_password1_receive, # -------- 암호화된 비밀번호(Hashlib)
...
#    print("user_id_receive==>"+user_id_receive)
#    print("user_password1_receive==>"+user_password1_receive)
#    app.logger.debug("user_id_receive: %s", user_id_receive)
#    app.logger.debug("user_password1_receive: %s", user_password1_receive)

#    # PW 암호화
#    pw_hash = hashlib.sha256(user_password1_receive.encode('utf-8')).hexdigest()
#    # print("pw_hash====>"+pw_hash)
#    # id, 암호화된pw을 가지고 해당 유저를 찾습니다.
#    result = db.user.find_one({'user_id': user_id_receive, 'user_password1': pw_hash})
#    # result = db.user.find_one({'user_id':user_id_receive, 'user_password1' :user_password1_receive})
#    print(result)
#    # 찾으면 JWT 토큰을 만들어 발급합니다.
#    if result is not None:
#       # JWT 토큰에는, payload와 시크릿키가 필요합니다.
